...
import { MapPin, Languages, MessageCircle, MoreVertical } from "lucide-react";
// Note: Make sure Image2.jpg exists at this path or update the import
    ...
    <div className="w-full max-w-[1440px] mx-auto py-12 pr-12">
      ...
      <section className="mb-8 sm:mb-12 lg:mb-16">
        <div className="flex flex-col sm:flex-row sm:justify-between sm:items-center mb-6 gap-4">
          ...
          <button className="text-[#515DEF] font-medium hover:text-[#3F4BDA] transition-colors duration-200 text-sm sm:text-base w-fit sm:w-auto">
            View All
          </button>
        </div>
